...
export const mockProducts: Product[] = [
  {
    ...
    category: "textbooks",
    condition: "like-new",
    images: ["/products/calculus-book.jpg"],
    sellerId: "user1",
  ...
  },
  {
    ...
    sellerAvatar: "/avatars/jordan.jpg",
  ...
  },
  {
    ...
    category: "textbooks",
    condition: "good",
    images: ["/products/psych-book.jpg"],
    sellerId: "user6",
    sellerName: "Lisa Martinez",
    sellerAvatar: "/avatars/lisa.jpg",
    location: "Library",
